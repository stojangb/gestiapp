    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          ?>
            <div style="color:#4e73df"><?php echo $registro["rut"]; ?>
              <div style="color:#4e73df"><?php echo $registro["giro"]; ?>
                <div style="color:#4e73df"><?php echo $registro["nombre_abreviado"]; ?>
                  <div style="color:#4e73df"><?php echo $registro["razon_social"]; ?>
                  </div>
                  <div>
                  <?php }  ?>
                  <br>
