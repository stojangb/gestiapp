      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Servicio <?php echo $_POST["id"]; ?></h1>
          </div>
          ...
          ?>
            ...
            foreach ($matrizFechas as $registro3) {
              ...
              echo ", "; ?>
              <input hidden type="text" name="" value="<?php echo $registro3["id"]; ?>" class="custom-file-input" id="idCliente">
            <?php } ?>
            <?php
            //RUT
            $matrizFechas = ControllerServicios::listarClientes($registro["idservicios"]);
            ...
            <div class="row">
              <div class="col-sm-4">
                <button id="idBotonCollapseMaritimo" type="button" data-toggle="collapse" href="#collapseMaritimo" class="btn btn-primary btn-lg btn-block">Marítimo</button>
              </div>
              <div class="col-sm-4">
                <button id="idBotonCollapseTerrestre" style="background-color: #685441;" type="button" data-toggle="collapse" href="#collapseTerrestre" class="btn btn-secondary btn-lg btn-block">Terrestre</button>
              </div>
              <div class="col-sm-4">
                <button id="idBotonCollapseOtros" type="button" data-toggle="collapse" href="#collapseOtros" class="btn btn-secondary btn-lg btn-block">Otro</button>
              </div>
            </div>
            <br>
            <div class="collapse" id="collapseMaritimo">
              <div class="card card-body">
                <div style="background-color: #f8f9fc;" class="container">
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input required type="number" value="" class="form-control" name="certificado" id="certificadoMaritimo" placeholder="Número">
                          <input value="" name="idIdMaritimo" id="idIdMaritimo" hidden>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label for="exampleFormControlSelect1">Producto a sanitizar</label>
                          <select class="form-control" id="idProductoMaritimo" name="nombre">
                            <input id="idProductoMaritimoComprobacion" hidden>
                            <input id="idCertificadoMaritimoComprobacion" hidden>
                          </select>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="checkbox" id="vuelta" name="vuelta1" value="true">
                          <label class="form-check-label" for="vuelta">¿Vuelta falsa?</label>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-4">
                        <div id="AgregarNuevoProductoMaritimo" name="AgregarNuevoProductoMaritimo"></div>
                      </div>
                      <div class="col-sm-4">
                        <!--   TIPO TRABAJO -->
                        <div class="form-group">
                          ...
                          ?>
                            <div class="form-check form-check-inline">
                              <input class="reiniciarMaritimo form-check-input seleccionMaritimo" type="checkbox" id="<?php echo $registro["id"] ?>" value="<?php echo $registro["id"] ?>">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <a data-toggle="modal" data-target="#exampleModalCenterMaritimo" style="color: blue;" type="button">¿No encuentra el producto?</a>
                    </div>
                    <div class="col-sm-3">
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          ...
                          ?>
                            <div class="form-check form-check-inline">
                              <input class="reiniciarTerrestre form-check-input seleccionTerrestre" type="checkbox" id="terr<?php echo $registro["id"] ?>" value="<?php echo $registro["id"] ?>">
                              <label class="form-check-label" for="terr<?php echo $registro["id"] ?>"><?php echo $registro["tipotrabajo"] ?></label>
                            </div>
                          <?php    }   ?>
                        </div>
                      </div>
